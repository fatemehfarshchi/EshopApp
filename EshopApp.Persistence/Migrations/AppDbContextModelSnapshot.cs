...
{
    /// <summary>
    /// Model snapshot for the application's database context.
    /// Reflects the current state of the entity model and schema.
    /// </summary>
    [DbContext(typeof(AppDbContext))]
    partial class AppDbContextModelSnapshot : ModelSnapshot
    {
        /// <summary>
        /// Configures the entity model for the application's current schema snapshot.
        /// </summary>
